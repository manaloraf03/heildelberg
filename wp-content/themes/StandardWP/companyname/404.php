...
<section id="error-page" class="section">
			...
			<?php } ?>
				<div id="content" role="main">
					...
					<div class="alert alert-warning">
						<h1><i class="glyphicon glyphicon-warning-sign"></i> <?php _e('Error', 'companyname'); ?> 404</h1>
						<p><?php _e('The page you were looking for does not exist.', 'companyname'); ?></p>
					</div>
				</div><!-- /#content -->
			</div>
