...
/**
 * Forces Plugin Mode when Theme Option is already loaded and displays an admin notice.
 */
if ( class_exists( 'OT_Loader' ) && defined( 'OT_PLUGIN_MODE' ) && OT_PLUGIN_MODE == true ) {
  ...
  function ot_conflict_notice() {
    ...
    echo '<div class="error"><p>' . __( 'Theme Option is installed as a plugin and also embedded in your current theme. Please deactivate the plugin to load the theme dependent version of Theme Option, and remove this warning.', 'option-tree' ) . '</p></div>';
...
/**
 * This is the Theme Option loader class.
 *
...
if ( ! class_exists( 'OT_Loader' ) ) {
  ...
  class OT_Loader {
    ...
    /** 
     * Load Theme Option on the 'after_setup_theme' action. Then filters will 
     ...
     * Constants
     *
     * Defines the constants for use within Theme Option. Constants 
    ...
    private function constants() {
       ...
       *
       * Run a filter and set to true to enable Theme Option theme mode.
       ...
       *
       * Run a filter and set to true to enable Theme Option child theme mode.
       * You must have this files parent directory inside of 
       * your themes root directory. As well, you must include 
       * a reference to this file in your themes functions.php.
       *
       ...
       *
       * Run a filter and set to false if you want to hide the Theme Option 
       ...
       *
       * Run a filter and set to false to keep Theme Option from
       ...
       *
       * Run a filter and set to true if you want Theme Option 
    ...
    public function change_image_button( $translation, $text, $domain ) {
      ...
      if ( $pagenow == apply_filters( 'ot_theme_options_parent_slug', 'themes.php' ) && 'default' == $domain && 'Insert into post' == $text ) {
        ...
        return apply_filters( 'ot_upload_text', __( 'Send to Theme Option', 'option-tree' ) );
  ...
  /**
   * Instantiate the Theme Option loader class.
   *
   * @since     2.0
   */
