            ...
            echo '<div class="wrap settings-wrap" id ="page-' . $page['id'] . '">';
              ...
              echo '<div id="option-tree-header-wrap">';
                ...
                echo '<ul id="option-tree-header">';
                  ...
                  echo '<li id="option-tree-logo">' . apply_filters( 'ot_header_logo_link', '<a href="http://wordpress.org/extend/plugins/option-tree/" target="_blank">Theme Option</a>', $page['id'] ) . '</li>';
                  
                  echo '<li id="option-tree-version"><span>' . apply_filters( 'ot_header_version_text', 'Theme Options ' . OT_VERSION, $page['id'] ) . '</span></li>';
