    ...
    if ( empty( $field_value ) && apply_filters( 'ot_type_social_links_load_defaults', true, $field_id ) ) {
      ...
      $field_value = apply_filters( 'ot_type_social_links_defaults', array(
        array(
          ...
          'title'   => __( 'Facebook', 'option-tree' ),
          'icon'    => '',
          'link'    => ''
        ),
        array(
          'name'    => __( 'Twitter', 'option-tree' ),
          'title'   => __( 'Twitter', 'option-tree' ),
          'icon'    => '',
          'link'    => ''
        ),
        array(
          'name'    => __( 'Google+', 'option-tree' ),
          'title'   => __( 'Google+', 'option-tree' ),
          'icon'    => '',
          'link'    => ''
        ),
        array(
          'name'    => __( 'LinkedIn', 'option-tree' ),
          'title'   => __( 'LinkedIn', 'option-tree' ),
          'icon'    => '',
          'link'    => ''
        ),
        array(
          'name'    => __( 'Pinterest', 'option-tree' ),
          'title'   => __( 'Pinterest', 'option-tree' ),
          'icon'    => '',
          'link'    => ''
        ),
        array(
          'name'    => __( 'Youtube', 'option-tree' ),
          'title'   => __( 'Youtube', 'option-tree' ),
          'icon'    => '',
          'link'    => ''
        ),
        array(
          'name'    => __( 'Tumblr', 'option-tree' ),
          'title'   => __( 'Tumblr', 'option-tree' ),
          'icon'    => '',
          'link'    => ''
        ),
        array(
          'name'    => __( 'Skype', 'option-tree' ),
          'title'   => __( 'Skype', 'option-tree' ),
          'icon'    => '',
          'link'    => ''
        ),
        array(
          'name'    => __( 'Vimeo', 'option-tree' ),
          'title'   => __( 'Vimeo', 'option-tree' ),
          'icon'    => '',
          'link'    => ''
        ),
        array(
          'name'    => __( 'Flickr', 'option-tree' ),
          'title'   => __( 'Flickr', 'option-tree' ),
          'icon'    => '',
          'link'    => ''
        )
      ), $field_id );
