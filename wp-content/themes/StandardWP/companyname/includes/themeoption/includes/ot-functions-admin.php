...
if ( ! function_exists( 'ot_register_settings_page' ) ) {
  ...
  function ot_register_settings_page() {
    ...
    $ot_register_pages_array =  array( 
      array( 
        'id'              => 'ot',
        'page_title'      => __( 'Theme Option', 'option-tree' ),
        'menu_title'      => __( 'Theme Option', 'option-tree' ),
...
if ( ! function_exists( 'ot_admin_styles' ) ) {
  ...
  function ot_admin_styles() {
    ...
    $screen_ids = apply_filters( 'ot_dequeue_jquery_ui_css_screen_ids', array( 
      ...
      'Theme Option_page_ot-documentation', 
 ...
 * @uses      wp_enqueue_script()     Add Theme Option scripts
...
if ( ! function_exists( 'ot_admin_scripts' ) ) {
  ...
  function ot_admin_scripts() {
    ...
    $localized_array = array( 
      ...
      'upload_text'           => apply_filters( 'ot_upload_text', __( 'Send to Theme Option', 'option-tree' ) ),
  ...
  function ot_social_links_settings( $id ) {
    ...
    $settings = apply_filters( 'ot_social_links_settings', array(
      ...
      array(
        'id'        => 'icon',
        'label'     => 'Icon',
        'desc'      => __( 'Enter Icon Links Ex. Font Awesome Links', 'option-tree' ),
        'type'      => 'text',
      ),
      array(
        'id'        => 'link',
        'label'     => 'Link',
        'desc'      => sprintf( __( 'Enter a link to the profile or page on the social website. Remember to add the %s on the first part of the link.', 'option-tree' ), '<code>http://</code>' ),
        'type'      => 'text',
      )
    ), $id );
  ...
  function ot_settings_view( $name, $key, $setting = array() ) {
    ...
    <div class="option-tree-setting">
      ...
      <div class="option-tree-setting-body">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . __( '<strong>Standard</strong>: Setting the standard value for your option only works for some option types. Read the <code>Theme Option->Documentation</code> for more information on which ones.', 'option-tree' ) . '</div>
            <div class="format-setting-inner">
              ' . $std_form_element . '
            </div>
          </div>
