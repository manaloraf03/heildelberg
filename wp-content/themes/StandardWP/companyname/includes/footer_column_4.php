<?php
	...
	if ( function_exists( 'ot_get_option' ) ) {
		...
		$column_04_address = ot_get_option( 'column_04_address' );
		$column_04_phone_number = ot_get_option( 'column_04_phone_number' );
		$column_04_email_address = ot_get_option( 'column_04_email_address' );
		$column_04_social = ot_get_option( 'column_04_social' );
		$column_01_page = ot_get_option( 'column_01_page' );
		$column_01_page_select = ot_get_option( 'column_01_page_select' );
		$column_04_page = ot_get_option( 'column_04_page' );
		$column_04_page_select = ot_get_option( 'column_04_page_select' );
		$footer_logo = ot_get_option( 'footer_logo' );
		$column_01_footer_logo = ot_get_option( 'column_01_footer_logo' );
		$column_04_footer_logo = ot_get_option( 'column_04_footer_logo' );
	}
	
?>
<?php if ( $footer_column == '4_column' ) { ?>
...
<div class="col-xs-12 col-sm-6 col-lg-4">
	...
	<?php if ( $column_01_address == on ) { ?>
		...
		<?php $company_address = preg_replace("/[\s_]/", "%", $store_company_address); ?>
		...
		<div class="media footer-address">
			...
			<div class="media-body">
				<a href="http://maps.google.com/?q=<?php echo $company_address ?>"><?php echo $store_company_address ?></a>
			</div>
		</div>
...
<div class="col-xs-12 col-sm-6 col-lg-4">
	...
	<?php dynamic_sidebar('footer-column-04'); ?>

	<?php if ( $column_04_footer_logo == on ) { ?>
	...
	<?php
		...
		if ( $column_04_page == on ) { 

			$post = get_post($column_04_page_select); 
			$content = apply_filters('the_content', $post->post_content); 
	...
	<?php if ( $column_04_phone_number == on ) { ?>
		<?php
	...
	<?php if ( $column_04_email_address == on ) { ?>
		<div class="media footer-email-address">
			<div class="media-left">
				<i class="fa fa-envelope" aria-hidden="true"></i>
			</div>
